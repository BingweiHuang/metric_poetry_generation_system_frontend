<template>
    <el-form :model="update_profile_form" :rules="update_profile_rules" ref="update_profile_dom" label-width="80px">
        ...
        <el-form-item label="公开收藏">
            <el-switch v-model="update_profile_form.display_collections" inline-prompt active-text="是"
                       inactive-text="否"/>
        </el-form-item>
        <el-form-item label="个人简介" prop="introduction">
            <el-input v-model="update_profile_form.introduction" type="textarea" :autosize="{ minRows: 3, maxRows: 3 }"
...
import {ElLoading, ElMessage, UploadInstance, UploadProps, UploadUserFile} from "element-plus";
...
export default {
    ...
    setup(props, context) {
        ...
        const baseUrl = 'http://cdn.bwhlifetimelove.top/'
