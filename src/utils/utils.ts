...
// axios.defaults.baseURL="http://1.12.62.89:8080";
...
function instance(axiosConfig, customOptions, loadingOptions) {
...
function getPendingKey(config) {
    ...
    if((typeof data) === 'string') data = JSON.parse(JSON.stringify(data)); // response里面返回的config.data是个字符串对象
