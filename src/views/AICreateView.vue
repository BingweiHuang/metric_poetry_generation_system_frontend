        ...
        <el-col :xl="14" :lg="14" :md="16" :sm="19" :xs="23" class="my">
            ...
            <el-card class="box-card" style="margin-bottom: 10px">
                    ...
                    <el-card class="box-card mx-card" shadow="never" v-loading="lstm_loading">
                        ...
                        <div v-else-if="lstm_display_state === 2">
                            <div v-for="(poem, index) in lstmCreateList" :key="index">
                                ...
                                <div class="ai_create_poetry" v-for="(sen, index2) in poem[2]" :key="index-index2">
                                    {{ sen }}
                                </div>
                            </div>
                        </div>
                ...
                <el-row justify="center" align="middle" :gutter="30">
                    <el-col :span="5">
                        <el-switch v-model="yan" size="large" inline-prompt
                                   ...
                                   active-text="七言" inactive-text="五言"/>
                    </el-col>
                    <el-col :span="5">
                        <el-switch v-model="jue" size="large" inline-prompt
                                   style="--el-switch-on-color: #13ce66; --el-switch-off-color: #ff4949"
                                   active-text="绝句" inactive-text="律句"/>
                    </el-col>
                    <el-col :span="5">
                        <el-switch v-model="qi" size="large" inline-prompt
                                   style="--el-switch-on-color: #13ce66; --el-switch-off-color: #ff4949"
                                   active-text="平起" inactive-text="仄起"/>
                    </el-col>
                    <el-col :span="5">
                ...
                <el-row justify="center" align="middle" :gutter="30">
                    ...
                    <el-col :span="8">
                        <el-button type="primary" id="lstm_create_button" @click="lstm_create" :loading="lstm_loading">
                            {{ lstm_button_state }}
                        </el-button>
                    </el-col>
            ...
            <el-card class="box-card">
                ...
                <el-row justify="center" align="middle" :gutter="30">
                    <el-col :span="5">
                        <el-switch v-model="yan2" size="large" inline-prompt
                                   style="--el-switch-on-color: #13ce66; --el-switch-off-color: #ff4949"
                                   active-text="七言" inactive-text="五言"/>
                    </el-col>
                    <el-col :span="5">
                        <el-switch v-model="jue2" size="large" inline-prompt
                                   style="--el-switch-on-color: #13ce66; --el-switch-off-color: #ff4949"
                                   active-text="绝句" inactive-text="律句"/>
                    </el-col>
                    <el-col :span="5">
                        <el-switch v-model="qi2" size="large" inline-prompt
                                   style="--el-switch-on-color: #13ce66; --el-switch-off-color: #ff4949"
                                   active-text="平起" inactive-text="仄起"/>
                    </el-col>
                    <el-col :span="5">
                        <el-tooltip content="首句是否押(入)韵" placement="top">
                            <el-switch v-model="ru2" size="large" inline-prompt active-text="入韵"
                                       inactive-text="不入"/>
                        </el-tooltip>
                    </el-col>
                </el-row>
                ...
                <el-row justify="center" align="middle" :gutter="30">
                    ...
                    <el-col :span="8">
                        <el-button type="primary" id="gpt2_create_button" @click="gpt2_create" :loading="gpt2_loading">
                            {{ gpt2_button_state }}
                        </el-button>
                    </el-col>
