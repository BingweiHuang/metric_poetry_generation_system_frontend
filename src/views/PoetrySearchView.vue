    ...
    <div>
            ...
            <el-col :xl="20" :lg="20" :md="20" :sm="20" :xs="24">
                ...
                <div v-else-if="poetry_dynasty_value && poetry_dynasty_value[0] === 'shijings'">
                    ...
                    <el-row justify="center" align="middle" :gutter="0">
                        ...
                        <el-col :span="8">
                            <el-select v-model="chapter_value" class="m-2" placeholder="Select" size="large"
                                       @change="chapter_change">
                                <!--                <template #prefix>
                                                  <span>篇:</span>
                                                </template>-->
                                <el-option
                        ...
                        <el-col :span="8">
                            <el-select v-model="section_value" class="m-2" placeholder="Select" size="large"
        ...
        <div style="min-height: 600px" class="my">
            <el-space size="" wrap style="width: 100%; justify-content: center;">
                <template
                        v-for="(poetry, idx) in poetryList.slice((currentPage - 1) * pageSize, currentPage * pageSize)"
                        :key="idx">
